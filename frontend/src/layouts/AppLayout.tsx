...
export function AppLayout() {
  ...
  const links = isAdmin ? [['Dashboard', '/admin/dashboard', '⌂'], ['Employees', '/employees', '♧'], ['Attendance', '/attendance', '◷'], ['Leave Approvals', '/admin/leave', '✓'], ['Payroll', '/payroll', '▤']] : [['Dashboard', '/employee/dashboard', '◈'], ['Profile', '/profile', '○'], ['Attendance', '/attendance', '◷'], ['Leave', '/leave', '◇'], ['Payroll', '/payroll', '▤']]
