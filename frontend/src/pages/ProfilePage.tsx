...
export function ProfilePage() {
  ...
  async function save(event: React.FormEvent) { event.preventDefault(); try { setSaving(true); setProfile(await updateProfile(form)); setEditing(false) } catch (requestError) { setError(apiErrorMessage(requestError)) } finally { setSaving(false) } }
  if (!user) return null
  return <>
