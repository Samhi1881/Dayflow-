...
export function Button({ children, type = 'button' }: { children: ReactNode; type?: 'button' | 'submit' }) { return <button className="button-primary" type={type}>{children}</button> }
...
export function ErrorState() { return <div className="placeholder"><h2>Something went wrong</h2><p>Please try again later.</p></div> }